                    ...
                    >
                        <x-slot name="icon">
                            <div class="flex items-center mr-4">
                                ...
                                >
                                    <x-cauri-icon class="rotate-90 text-theme-success-600 border-theme-success-600" name="check-mark" size="sm" />
                                </x-delegates.progress-circle>
                            </div>
                        </x-slot>
                    </x-general.header-entry>
                    ...
                    >
                        <x-slot name="icon">
                            <div class="flex items-center mr-4">
                                ...
                                >
                                    <x-cauri-icon class="rotate-90 text-theme-warning-500 border-theme-warning-500" name="pause" size="sm" />
                                </x-delegates.progress-circle>
                            </div>
                        </x-slot>
                    </x-general.header-entry>
                    ...
                    >
                        <x-slot name="icon">
                            <div class="flex items-center mr-4">
                                ...
                                >
                                    <x-cauri-icon class="rotate-90 text-theme-danger-400 border-theme-danger-400" name="cross" size="sm" />
                                </x-delegates.progress-circle>
                            </div>
                        </x-slot>
                    </x-general.header-entry>
                        ...
                        <x-slot name="icon">
                            <div class="flex items-center mr-4">
                                <x-delegates.progress-circle circle-color="primary-600" progress="{{ Percentage::calculate((int) $statistics['blockCount'], Network::delegateCount()) }}">
                                    <x-cauri-icon class="rotate-90 text-theme-primary-600 border-theme-primary-600" name="app-block-id" />
                                </x-delegates.progress-circle>
                            </div>
                        </x-slot>
                    </x-general.header-entry>
                                ...
                                <div class="flex items-center md:mr-4">
                                    <div class="hidden rounded-full border-4 border-white md:flex text-theme-secondary-900 dark:text-theme-secondary-600 dark:border-theme-secondary-900">
                                        <div
                                            ...
                                            <x-cauri-icon name="app-transactions.delegate-registration" />
                                        </div>
                                    </div>
                                </div>
                            </x-slot>
