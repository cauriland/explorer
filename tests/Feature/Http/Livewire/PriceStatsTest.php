...
it('should render the values', function () {
    ...
    (new NetworkStatusBlockCache())->setHistoricalHourly('DCAU', 'USD', collect(['1.898', '1.904', '1.967', '1.941', '2.013', '2.213', '2.414', '2.369', '2.469', '2.374', '2.228', '2.211', '2.266', '2.364', '2.341', '2.269', '1.981', '1.889', '1.275', '1.471', '1.498', '1.518', '1.61', '1.638']));
...
it('should render the placeholder values when no price cached yet', function () {
    ...
    (new NetworkStatusBlockCache())->setPrice('DCAU', 'USD', null);
    (new NetworkStatusBlockCache())->setHistoricalHourly('DCAU', 'USD', collect(['1.898', '1.904', '1.967', '1.941', '2.013', '2.213', '2.414', '2.369', '2.469', '2.374', '2.228', '2.211', '2.266', '2.364', '2.341', '2.269', '1.981', '1.889', '1.275', '1.471', '1.498', '1.518', '1.61', '1.638']));
...
it('should render the placeholder values when no historial data yet', function () {
    ...
    (new NetworkStatusBlockCache())->setPrice('DCAU', 'USD', 1);
    (new NetworkStatusBlockCache())->setHistoricalHourly('DCAU', 'USD', null);
