...
it('should render with a height, supply and market cap', function () {
    ...
    Livewire::test(NetworkStatusBlock::class)
        ...
        ->assertSee('136,280,982 CAU') // Supply
...
it('should render with a height, supply and market cap for BTC', function () {
    ...
    (new NetworkStatusBlockCache())->setPrice('CAU', 'BTC', 0.00003132);
    (new NetworkStatusBlockCache())->setHistoricalHourly('CAU', 'BTC', collect());
...
it('should render the price change', function () {
    ...
    (new NetworkStatusBlockCache())->setPriceChange('DCAU', 'USD', 0.137);
    (new NetworkStatusBlockCache())->setPrice('DCAU', 'USD', 1);
    (new NetworkStatusBlockCache())->setHistoricalHourly('DCAU', 'USD', collect());
...
it('handle price change when price is zero', function () {
    ...
    (new NetworkStatusBlockCache())->setPriceChange('DCAU', 'USD', 0);
    (new NetworkStatusBlockCache())->setPrice('DCAU', 'USD', 1);
    (new NetworkStatusBlockCache())->setHistoricalHourly('DCAU', 'USD', collect());
