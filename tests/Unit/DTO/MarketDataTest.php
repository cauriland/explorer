...
it('should make an instance from the cryptocompare response', function () {
    ...
    Arr::set($response, 'RAW.CAU.USD.PRICE', 11.21);
    Arr::set($response, 'RAW.CAU.USD.CHANGEPCT24HOUR', 1.62 * 100);

    $subject = MarketData::fromCryptoCompareApiResponse('CAU', 'USD', $response);
