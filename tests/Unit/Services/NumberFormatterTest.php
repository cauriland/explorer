...
it('should format a number without a currency symbol from a satoshi value', function () {
    assertMatchesSnapshot(NumberFormatter::satoshi('12300000000', 'CAU'));
});

it('should format a number with a currency symbol', function () {
    assertMatchesSnapshot(NumberFormatter::currency(123, 'CAU'));
    assertMatchesSnapshot(NumberFormatter::currency(1e8, 'CAU'));
});

it('should format a number with a currency symbol if it has a [.]', function () {
    assertMatchesSnapshot(NumberFormatter::currency(123.456, 'CAU'));
    assertMatchesSnapshot(NumberFormatter::currency('0.000003', 'CAU'));
});
...
it('should format a number without a suffix', function () {
    assertMatchesSnapshot(NumberFormatter::currencyWithoutSuffix(123, 'CAU'));
    assertMatchesSnapshot(NumberFormatter::currencyWithoutSuffix(1e8, 'CAU'));
});
...
it('should format a number with a currency short notation if it is too large', function () {
    assertMatchesSnapshot(NumberFormatter::currencyShort(1000, 'CAU'));
    assertMatchesSnapshot(NumberFormatter::currencyShort(10000, 'CAU'));
    assertMatchesSnapshot(NumberFormatter::currencyShort(100000, 'CAU'));
    assertMatchesSnapshot(NumberFormatter::currencyShort(1000000, 'CAU'));
    assertMatchesSnapshot(NumberFormatter::currencyShort(10000000, 'CAU'));
    assertMatchesSnapshot(NumberFormatter::currencyShort(100000000, 'CAU'));
    assertMatchesSnapshot(NumberFormatter::currencyShort(1000000000, 'CAU'));
    assertMatchesSnapshot(NumberFormatter::currencyShort(10000000000, 'CAU'));
    assertMatchesSnapshot(NumberFormatter::currencyShort(100000000000, 'CAU'));
    assertMatchesSnapshot(NumberFormatter::currencyShort(1000000000000, 'CAU'));
    assertMatchesSnapshot(NumberFormatter::currencyShort(10000000000000, 'CAU'));
    assertMatchesSnapshot(NumberFormatter::currencyShort(100000000000000, 'CAU'));
});
